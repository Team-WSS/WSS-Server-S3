...
public interface S3DefaultService {
     ...
     */
    S3UploadResult upload(String objectKey, File file);
     ...
     * @return 업로드 결과를 담은 {@link S3UploadResult} 객체
     */
    S3UploadResult upload(String objectKey, File file, String contentType);
     ...
     * @return 업로드 결과를 담은 {@link S3UploadResult} 객체
     */
    S3UploadResult upload(String objectKey, InputStream inputStream, String contentType, long contentLength);
